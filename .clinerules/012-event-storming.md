...
結果は `.clinerules/specs/step4.md` に markdown 形式で保存します。
モデリング結果を以下のテンプレートで作成してください。
...
- ステップ1の結果は `.clinerules/specs/step1.md` に記録します
- ステップ2の結果は `.clinerules/specs/step2.md` に記録します
- ステップ3の結果は `.clinerules/specs/step3.md` に記録します
- ステップ4の結果は `.clinerules/specs/step4.md` に記録します
